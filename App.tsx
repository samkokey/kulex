...
// ==========================================
// Vite build sırasında bu değişkenleri statik stringlerle değiştirir.
// Eğer tanımlı değilse boş string döner.
// import.meta.env?.VITE_... kullanımı runtime hatasını engeller.
